...
// import React from "react";
// import "bootstrap/dist/css/bootstrap.min.css";
// import "../Components/Styles/getStart.css";
...
//       {/* Page Title */}
//       <section className="getstart-header text-center">
//         <div className="container">
//           <h2 className="fw-bold">Our Transparent Pricing Plans</h2>
...
//               <h1 className="plan-title">MONTHLY</h1>
//               <h2 className="price-01">
//                 $29<sup>99</sup>
//               </h2>
//               <p className="price-type">per month</p>
...
//                 <li className="disabled">Interactive Courses</li>
//                 <li className="disabled">Extra Exercises</li>
//                 <li className="disabled">Offline Viewing</li>
//               </ul>
...
//           {/* ANNUAL (HIGHLIGHTED) */}
//           <div className="col-lg-4 col-md-6">
//             <div className="pricing-card text-center active">
//               <h1 className="plan-title">ANNUAL</h1>
//               <h2 className="price-01">
//                 $249<sup>99</sup>
//               </h2>
//               <p className="price-type">per year</p>
...
//           <div className="col-lg-4 col-md-6">
//             <div className="pricing-card text-center">
//               <h1 className="plan-title">BUSINESS</h1>
//               <h2 className="price-01">
//                 $499<sup>99</sup>
//               </h2>
//               <p className="price-type">per year</p>
