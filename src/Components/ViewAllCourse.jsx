...
// import "../Components/Styles/ViewAllCourse.css";
...
//       {/* Banner */}
//       <section className="category-hero d-flex align-items-center">
...
//             <span className="fs-5">
//               <strong>3486</strong> courses found in <strong>18 categories</strong>
//             </span>
...
//               <i className={`bi ${item.icon} category-icon`}></i>
//               <h6 className="mt-3 fw-semibold text-dark">{item.title}</h6>
...
//             libero mauris donec ociis and neque.
//           </p>
//         </div>
...
//   alt="Education"
//   className="img-fluid rounded-4 w-100 mx-auto d-block"
// />
//         </div>
...
//             <i className="bi bi-book fs-1 text-dark"></i>
...
//           <div className="col-md-4">
//             <i className="bi bi-person-check fs-1 text-dark"></i>
...
//           <div className="col-md-4">
//             <i className="bi bi-infinity fs-1 text-dark"></i>
