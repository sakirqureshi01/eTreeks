...
//   </a>
//    <span class="input-group-text" id="basic-addon2">ContactUs</span>
...
//         {/* Cards */}
//         <div className="row g-0 contact-box shadow-sm">
...
//             <h5 className="fw-bold mt-3">Our Location</h5>
//             <p className="text-muted">
//               121 King Street, Melbourne, Victoria <br /> 3000 Australia
//             </p>
...
//           <div className="col-md-4 contact-card border-start">
//             <FaGlobe className="contact-icon" />
//             <h5 className="fw-bold mt-3">Partnership Request</h5>
//             <p className="text-muted">
//               For partnership and business <br /> development inquiries
//             </p>
//             <button className="btn btn-outline-secondary">
//               hello@yourdomain.com
//             </button>
...
//             <h5 className="fw-bold mt-3">Need Help?</h5>
//             <p className="text-muted">
//               Have questions about teaching and <br /> career opportunities?
//             </p>
//             <button className="btn btn-outline-secondary">
//               hello@yourdomain.com
//             </button>
