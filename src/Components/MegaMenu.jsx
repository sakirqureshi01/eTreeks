...
// import React from "react";
// import "bootstrap/dist/css/bootstrap.min.css";
// import "../Components/Styles/MegaMenu.css";
...
//           <div className="col-lg-3">
//             <h6 className="fw-bold mb-4">TOP 5 ONLINE COURSES:</h6>
//             <ul className="list-unstyled course-list">
//               <li>English for Tourism</li>
//               <li>Python Programming - Working with Lists and Files</li>
//               <li>Computer Networking - Wired and Wireless Networks</li>
//               <li>Digital Marketing: The Ultimate Guide to Strategic</li>
//               <li>The Complete iOS 10 & Swift 3 Developer Course</li>
//             </ul>
//           </div>

        
//           <div className="col-lg-6">
//             <h6 className="fw-bold mb-4">FEATURED NEWS:</h6>
...
//           {/* RIGHT: LATEST NEWS */}
//           <div className="col-lg-3">
//             <h6 className="fw-bold mb-4">LATEST NEWS:</h6>

//             <div className="latest-item">
//               <img
//                 src="https://jthemes.net/themes/html/etreeks/files/images/blog/latest-post-1.jpg"
//                 alt="news"
//               />
//               <div>
//                 <p className="mb-1">
//                   Etiam sapien risus ante auctor tempus an accumsan...
//                 </p>
//                 <small className="text-muted">18 hours ago</small>
//               </div>
//             </div>

//             <div className="latest-item">
//               <img
//                 src="https://jthemes.net/themes/html/etreeks/files/images/blog/latest-post-2.jpg"
//                 alt="news"
//               />
//               <div>
//                 <p className="mb-1">
//                   Blandit tempor sapien ipsum, porta risus auctor justo...
//                 </p>
//                 <small className="text-muted">Feb 17, 2020</small>
//               </div>
//             </div>

//             <div className="latest-item">
//               <img
//                 src="https://jthemes.net/themes/html/etreeks/files/images/blog/latest-post-3.jpg"
//                 alt="news"
//               />
//               <div>
//                 <p className="mb-1">
//                   Cursus risus an auctor risus laoreet undo auctor varius...
//                 </p>
//                 <small className="text-muted">Feb 07, 2020</small>
//               </div>
//             </div>
